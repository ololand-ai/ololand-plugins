...
description: "Use when the user asks to run the OloLand /forensic-screen workflow. Run a Pre-LOI Forensic Screen — full battery of Beneish M-Score, Benford's Law, EBITDA bridge, journal-entry testing, lapping detection, and working-capital deep dive on a deal. The $7,500 / 72-hour wedge product against Big-4 QoE."
---
