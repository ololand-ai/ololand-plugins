---
name: ololand-dd-dd-merger-analyze
description: "Use when the user asks to run the OloLand /dd-merger-analyze workflow. Run a third-party merger analysis on an announced or rumored acquisition. Use when the user is not a principal in the deal (banker, equity analyst, merger-arb, antitrust counsel, target board, journalist). Pro+ subscription required."
---

<!-- Generated by scripts/generate-plugin-artifacts.py; do not edit. -->

# Codex wrapper for /dd-merger-analyze

Follow the OloLand command instructions below when the user asks for `/dd-merger-analyze` or the equivalent workflow in Codex.
