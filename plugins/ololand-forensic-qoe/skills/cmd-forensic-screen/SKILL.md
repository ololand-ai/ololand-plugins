---
name: ololand-forensic-qoe-forensic-screen
description: "Use when the user asks to run the OloLand /forensic-screen workflow. Run a Pre-LOI Forensic Screen — full battery of Beneish M-Score, Benford's Law, EBITDA bridge, journal-entry testing, lapping detection, and working-capital deep dive on a deal. Included in OloLand Pro and above, positioned against Big-4 QoE."
---
