...
- `/dd-analyze <deal_id>` — run bounded extraction, risk, and financial-snapshot processing once the annual filing (10-K, 20-F, or 40-F; or ingested S-1) finishes processing. Cross-document reconciliation is a separate explicit action.
