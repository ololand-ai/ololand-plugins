...
description: "Use when the user asks to run the OloLand /cim-generate workflow. Generate or read the latest 14-section Confidential Information Memorandum (CIM) for a deal, built from OloLand's reconciled deal data rather than LLM prose."
---
