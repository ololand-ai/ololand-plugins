---
name: ololand-dd-risk-report
description: "Use when the user asks to run the OloLand /risk-report workflow. Generate a structured risk report for a deal — 246-category taxonomy with severity scoring, evidence links, and institutional patterns from similar deals."
---

<!-- Generated by scripts/generate-plugin-artifacts.py; do not edit. -->

# Codex wrapper for /risk-report

Follow the OloLand command instructions below when the user asks for `/risk-report` or the equivalent workflow in Codex.
