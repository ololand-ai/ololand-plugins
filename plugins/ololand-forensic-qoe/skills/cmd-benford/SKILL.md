---
name: ololand-forensic-qoe-benford
description: "Use when the user asks to run the OloLand /benford workflow. Run Benford's Law first-digit testing on a deal's general-ledger transactions to detect numeric fabrication or selective entry."
---
