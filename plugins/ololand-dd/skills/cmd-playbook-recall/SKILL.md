---
name: ololand-dd-playbook-recall
description: "Use when the user asks to run the OloLand /playbook-recall workflow. Pull your firm's playbook for deals like this — what worked, what didn't, what got missed in similar past deals. Wraps cross-deal learning + per-deal outcome metadata."
---

<!-- Generated by scripts/generate-plugin-artifacts.py; do not edit. -->

# Codex wrapper for /playbook-recall

Follow the OloLand command instructions below when the user asks for `/playbook-recall` or the equivalent workflow in Codex.
