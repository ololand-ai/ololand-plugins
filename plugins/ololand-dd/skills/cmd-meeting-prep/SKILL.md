---
name: ololand-dd-meeting-prep
description: "Use when the user asks to run the OloLand /meeting-prep workflow. Prep for a diligence meeting — generate a one-page question list grounded in this deal's actual risks, evidence, and similar-deal patterns. Every question cites a source."
---

<!-- Generated by scripts/generate-plugin-artifacts.py; do not edit. -->

# Codex wrapper for /meeting-prep

Follow the OloLand command instructions below when the user asks for `/meeting-prep` or the equivalent workflow in Codex.
