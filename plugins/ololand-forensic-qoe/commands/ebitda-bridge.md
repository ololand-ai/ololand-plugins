---
description: Build the EBITDA bridge with an adjustment classifier — categorizes every add-back as one-time, pro-forma, or questionable and returns a normalized EBITDA with each adjustment cited.
---
